          ...
          reservations: [
            {
              ...
              visualBegin: moment('2016-01-01T02:00:00').format('YYYY-MM-DDTHH:mm:ss'),
              visualEnd: moment('2016-01-01T10:00:00').format('YYYY-MM-DDTHH:mm:ss'),
            },
            {
              id: 222,
              name: 'Reservation 2',
              ...
              visualBegin: moment('2016-01-01T11:30:00').format('YYYY-MM-DDTHH:mm:ss'),
              visualEnd: moment('2016-01-01T18:00:00').format('YYYY-MM-DDTHH:mm:ss'),
            },
            {
              id: 333,
              name: 'Reservation 3',
              ...
              visualBegin: moment('2016-01-01T18:00:00').format('YYYY-MM-DDTHH:mm:ss'),
              visualEnd: moment('2016-01-01T23:30:00').format('YYYY-MM-DDTHH:mm:ss'),
            },
          ],
        },
        'resource-2': {
